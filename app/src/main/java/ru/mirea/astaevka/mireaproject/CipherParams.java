...
public class CipherParams {
    ...
    /**
     * Таблица замен. В методе {@link #replace(int)} используется по умолчанию. Может выбираться, как параметр метода
     * {@link #replace(int, byte[][])}
     */
    ...
    /**
     * Таблица замен. Может выбираться, как параметр метода {@link #replace(int, byte[][])}
     */
