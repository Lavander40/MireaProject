package ru.mirea.astaevka.mireaproject.ui.camera;
...
import ru.mirea.astaevka.mireaproject.databinding.FragmentCameraBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Log.d(CameraFragment.class.getSimpleName(), "is OnClick: " + isWork);
                //if (isWork) {
                    try {
        ...
        return binding.getRoot(); //inflater.inflate(R.layout.fragment_camera, container, false);
    }
