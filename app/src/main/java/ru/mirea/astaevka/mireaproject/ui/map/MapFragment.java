package ru.mirea.astaevka.mireaproject.ui.map;
...
import ru.mirea.astaevka.mireaproject.databinding.FragmentMapBinding;
...
public class MapFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        place("МИРЭА - Российский техногический университет",
                R.drawable.mirea, R.drawable.mirea_ico, 55.794229, 37.700772);
        place("МЕГА Белая Дача - торгово-развлекательный центр",
                R.drawable.mega, R.drawable.mega_ico, 55.654745, 37.844845);
        place("Мой дом - просто дом",
                R.drawable.dom, R.drawable.dom_ico, 55.648844, 37.861258);
    ...
    public void place(String text, Integer drawable, Integer icon, Double aLatitude, Double aLongitude){
        Marker marker = new Marker(mapView);
